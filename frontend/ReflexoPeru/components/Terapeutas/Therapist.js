...
function getusersTherapist() {
  ...
  if (tableBody) {
    axios
      .get("http://localhost/Proyecto01/Api/public/index.php/terapeutas")
      .then((response) => {
          ...
          row.innerHTML = `
            ...
            <td>
              <div class="Buttons-actions">
                <button onclick="editUserTherapist(${user.id})"><h4>Editar</h4></button>
                <button onclick="deleteUserTherapist(${user.id})"><h4>Eliminar</h4></button>
              </div>
            </td>
          `;
...
function RegistrarUserTherapist() {
